 ...
 */
export const handleVonageEventsWithoutRunApiV1TelephonyVonageEventsPost = <ThrowOnError extends boolean = false>(options?: Options<HandleVonageEventsWithoutRunApiV1TelephonyVonageEventsPostData, ThrowOnError>) => (options?.client ?? client).post<HandleVonageEventsWithoutRunApiV1TelephonyVonageEventsPostResponses, HandleVonageEventsWithoutRunApiV1TelephonyVonageEventsPostErrors, ThrowOnError>({ url: '/api/v1/telephony/vonage/events', ...options });
